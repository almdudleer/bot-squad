...
def orientation_block(
    *,
    ...
    lines += [
        ...
        "   bot-squad's peer message bus types the literal words `check mail`",
        "   into your composer when another session sends you something. That is",
        "   the whole signal. When you see it, run exactly:",
        "       bsq inbox check",
        "   Send to a peer with:",
